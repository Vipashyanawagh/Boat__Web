...
export default function SaleCards() {
  return (
    <div className="bg-gray-100 min-h-screen p-6  ">
      ...
      {/* Cards Container */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 columns-6  ">
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden">
          <img 
            ...
            alt="product"
            className="w-full h-52 object-cover aspect-3/2 "
          />
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden">
          <img
            ...
            alt="product"
            className="w-full h-52 object-cover aspect-square "
          />
       ...
       <div className ='bg-white rounded-2xl   shadow-md  '>
        <div>
          <img className='rounded-2xl  aspect-square ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1dARd8W_onbDpJL5Xj4McmuwuEr1U4qaXmA&s"></img>
        </div>
        <div className='bg-yellow-400 px-3 py-2 flex justify-between text-sm font-semibold '>
      ...
      {/*Cards 4 */}
       <div className ='bg-white rounded-2xl   shadow-md  '>
        <div>
          <img className='rounded-2xl aspect-square ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeNGJ_-IdT7YCbi4E3EXof13JwpiHgEpJKPQ&s"></img>
        </div>
        <div className='bg-yellow-400 px-3 py-2 flex justify-between text-sm font-semibold '>
           <span className='text-1 '>KeyChain Compatible </span>
           <span className='bg-white p-0.5 rounded-lg '> ⭐4.3 </span>
      ...
      {/*Cards 4 */}
       <div className ='bg-white rounded-2xl   shadow-md  '>
        <div>
          <img className='rounded-2xl aspect-square ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsRwZjCSvvCv26zDQ_Wk9qDtRq1Xapz6YacQ&s"></img>
        </div>
        <div className='bg-yellow-400 px-3 py-2 flex justify-between text-sm font-semibold '>
           <span className='text-1 '>KeyChain Compatible </span>
           <span className='bg-white p-0.5 rounded-lg '> ⭐4.3 </span>
       ...
       <div className ='bg-white rounded-2xl   shadow-md  '>
        <div>
          <img className='rounded-2xl aspect-square ' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMI0rEs2T7LDsdOOCC6qOIIgl0S3ffYFzZrw&s"></img>
        </div>
        <div className='bg-yellow-400 px-3 py-2 flex justify-between text-sm font-semibold '>
           <span className='text-1 '>KeyChain Compatible </span>
           <span className='bg-white p-0.5 rounded-lg '> ⭐4.3 </span>
